  ...
  editEmployee = (callback) => {
    ...
    this.connection.query("SELECT id, first_name, last_name FROM employee", (error, results) => {
      ...
      inquirer
        ...
        .then((employee) => {
          // choose name, role, or departmwent to edit
          inquirer
            .prompt([
              {
                name: "selection",
            ...
            .then((whatToEdit) => {
              switch (whatToEdit.selection) {
                case "Name":
                  ...
                  const prevFirstName = employee.employeeSelection
                  ...
                  const prevLastName = employee.employeeSelection
                    .substr(employee.employeeSelection.lastIndexOf(" "))
                    .trim();
                  inquirer
                    .prompt([
                      {
                        ...
                        default: prevFirstName,
                      },
                      {
                        name: "newLastName",
                        type: "input",
                        message: "Enter new last name (hit Enter to accept previous entry):",
                        default: prevLastName,
                      },
                    ])
                    .then((answer3) => {
                      // if different, update in DB
                      if (answer3.newFirstName !== prevFirstName || answer3.newLastName !== prevLastName) {
